          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <a
                ...
                aria-label="LinkedIn"
                className="w-8 h-8 flex items-center justify-center rounded bg-on-secondary/10
          ...
          <div>
            ...
            <address className="not-italic text-sm text-on-secondary/80 space-y-1 leading-relaxed">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 text-on-secondary/80 hover:text-on-secondary transition-colors duration-150 pt-0.5"
              >
        ...
        <div className="mt-8 pt-6 border-t border-on-secondary/20 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-on-secondary/60">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="flex items-center hover:text-on-secondary transition-colors duration-150"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
